...
class BaseTrainer:
    ...
    def train(self, max_epochs, load_latest=False, fail_safe=True, load_previous_ckpt=False, distill=False):
        ...
        args:
            ...
            load_latest - Bool indicating whether to resume from latest epoch. 加载最新checkpoint继续训
        ...
        for i in range(num_tries):
            try:
                ...
                for epoch in range(self.epoch + 1, max_epochs + 1):
                    ...
                    save_epochs = [1, 20]
                    if epoch > (max_epochs - 10) or save_every_epoch or epoch % 1 == 0 or epoch in save_epochs:
