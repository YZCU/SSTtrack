...
def _save_tracker_output(seq: Sequence, tracker: Tracker, output: dict):
    ...
    if not os.path.exists(os.path.join(tracker.results_dir, 'fps')):
        print("create tracking fps dir:", os.path.join(tracker.results_dir, 'fps'))
        os.makedirs(os.path.join(tracker.results_dir, 'fps'))
